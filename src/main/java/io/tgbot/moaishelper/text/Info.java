...
public class Info {
    ...
    public static final String ABOUT_SCHEDULES =
            EmojiParser.parseToUnicode("""
                    В нашем проекте есть 2 вида расписания, которые можно заполнять с помощью Excel файла
                    или диалогом с ботом:
                    
                    1) <b>Дробное</b> <i>(числитель/знаменатель)</i> - расписание занятий чередуется по четности номера недели.
                    Например, сначала идет четная неделя, затем нечетная, затем снова четная.
                    Чтобы заполнить такое расписание вручную необходимо заполнить каждое из 2х возможных видов недель.
                    
                    2) <b>Постоянное</b> - обычное расписание, одинаковое для каждой недели.
                    Чтобы заполнить такое расписание вручную рекомендуется заполнить расписание числителя.
                    Затем скопировать его в расписание знаменателя.
                    """);
